...
pdf_path = os.path.join(_root, "../../_test_scripts/datasheet_converter/tps92520/datasheet.pdf")
...
def extract_text_and_query(pdf_path, llm_model, query):
    ...
    response = client.models.generate_content(model="gemini-2.0-flash-001", contents=[query, text])
