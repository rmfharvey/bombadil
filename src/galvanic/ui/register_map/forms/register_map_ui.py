...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.register_map_scrollarea.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.register_map_scrollarea.setSizeAdjustPolicy(QAbstractScrollArea.AdjustIgnored)
        ...
        self.register_map_scrollarea_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
